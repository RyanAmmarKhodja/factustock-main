        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AI = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                    ...
                    N_Facture = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaxAdminAccounts = table.Column<int>(type: "integer", nullable: false),
                    MaxUserAccounts = table.Column<int>(type: "integer", nullable: false),
                    MaxTotalAccounts = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Produits_Companies_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "Companies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.InsertData(
                table: "Plans",
                columns: new[] { "Id", "IsActive", "MaxAdminAccounts", "MaxTotalAccounts", "MaxUserAccounts", "Name", "Price", "SetupFee" },
                values: new object[,]
                {
                    { 1, true, 1, 3, 2, "Starter", 5000m, 30000m },
                    { 2, true, 1, 6, 5, "Business", 8000m, 30000m },
                    { 3, true, 2, 12, 10, "Pro", 12000m, 50000m }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Full system access", "superadmin", null },
                    { 2, "Company admin access", "admin", null },
                    { 3, "Standard user access", "employee", null }
                });
